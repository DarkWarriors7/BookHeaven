...
const mobileNav = () => {
  ...
  return (
    <>
      {role==="user" && <div className='w-full lg:hidden flex items-center justify-between mt-4'>
      <Link to="/profile" 
    ...
    {role==="admin" && <div className='w-full lg:hidden flex items-center justify-between mt-4'>
      <Link to="/profile" 
          className="text-zinc-100 font-semibold w-full py-2 text-center hover:bg-zinc-900 rounded transition-all duration-300" >
          All Orders
          </Link>
