...
const Sidebar = ({ data }) => {
  ...
  return (
    <div className='bg-zinc-800 p-4 rounded flex flex-col items-center justify-between h-auto lg:h-[100%]'>
      <div className='flex items-center flex-col items-between justify-center'>
      ...
      {role === "user" && <div className="w-full items-center justify-center hidden flex-col  lg:flex">
        <Link to="/profile"
